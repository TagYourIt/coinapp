package
{
	...
	public class CoinApp extends Sprite
	{
		private var mStarling:Starling;
		
		public function CoinApp()
		{
			...
			//var startupImage:Sprite = createStartupImage(viewPort, screenWidth > 1024);
			//addChild(startupImage);
			
			// Set up Starling
			
			mStarling = new Starling(Game, stage, viewPort);
			mStarling.antiAliasing = 1; //(0-16 higher more lag in performance)
